...
@Component
public class Glitterhost2FanoutExchangeSender {

    private static final Logger logger = LoggerFactory.getLogger(Glitterhost2FanoutExchangeSender.class);
