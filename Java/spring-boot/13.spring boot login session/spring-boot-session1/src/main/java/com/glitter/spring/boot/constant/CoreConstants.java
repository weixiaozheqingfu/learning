...
public class CoreConstants {
     ...
     * 500 StringERNAL SERVER ERROR - [*]：服务器发生错误，用户将无法判断发出的请求是否成功。
     */
    ...
    private static final String UNPROCESABLE = "422";
    private static final String StringERNAL_SERVER_ERROR = "500";
