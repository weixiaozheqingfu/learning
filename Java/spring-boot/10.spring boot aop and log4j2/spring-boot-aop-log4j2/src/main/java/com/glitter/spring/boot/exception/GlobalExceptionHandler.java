...
public class GlobalExceptionHandler {
    ...
    public ResponseResult handleBusinessException(BusinessException e) {
        try {
            ...
            logger.error("GlobalExceptionHandler.handleBusinessException 获取业务异常信息:{}", JSONObject.toJSONString(e));
    ...
    public ResponseResult handleException(Exception e) {
        try {
            logger.error("GlobalExceptionHandler.handleException 获取运行异常信息:{}", JSONObject.toJSONString(e));
