...
/**
 ...
 解决了Singleton3中不能懒加载的问题,这种方式是用到的时候即调用getInstance()的时候,才会触发内部类SingletonHolder的类加载,
 进而执行方法体:private static final Singleton5 INSTANCE = new Singleton5()进行单例对象的创建。
...
public class Singleton5 {
    ...
    public void sysout() {
        System.out.println("当前实例对象:" + SingletonHolder.INSTANCE);
    }
}
