...
public class AdapterTest {
    ...
    public void HdmiAdapterTest() {
        ...
        Object handler = this.getHandler("hdmi");
    ...
    private Object getHandler(String param) {
        ...
        if (param.equals("microUsb")) {
            MicroUsbService microUsbService = new MicroUsbServiceImpl();
            return microUsbService;
        }
        if (param.equals("mobileTypec")) {
            MobileTypecService mobileTypecService = new MobileTypecServiceImpl();
