...
public class Main extends AliPayServiceImpl {
    ...
    public static void main(String[] args){
        // 使用继承的方式实现静态代理
        IPayService aliPayService$TimeProxy = new AliPayService$TimeProxyImpl();
        aliPayService$TimeProxy.pay(5L);

        IPayService weChatPayService$TimeProxy = new WeChatPayService$TimeProxyImpl();
        weChatPayService$TimeProxy.pay(6L);
